         ...
         spec:
           ...
           - name: myawesometmlsolution-3f10
             ...
             - name: step1solutiontitle # STEP 1 solutiontitle field can be adjusted here. 
               value: 'IoT Real-Time Monitoring Solution'                              
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolution-3f10 53621:53621

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:53621/dashboard.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
