...
.. list-table::
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolution-3f10.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolution-3f10.yml; this yaml is 
...
.. important::
   ...
   These YML files can also be found on GitHub at: https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-3f10/ymls/myawesometmlsolution-3f10
...
.. code-block:: YAML
         ...
         spec:
           ...
           - name: myawesometmlsolution-3f10
             ...
             - name: step4preprocesstypes # STEP 4
               value: 'anomprob,trend,avg,zscore'                                                         
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolution-3f10-visualization-service
       labels:
         app: myawesometmlsolution-3f10-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolution-3f10 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolution-3f10.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolution-3f10.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolution-3f10.yml
