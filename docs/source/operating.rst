...
Generated On: 2024-10-23 22:12:16 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=36011  \-\-env VIPERVIZPORT=40795  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:40795/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:40795/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 45281:45281 -p 51771:51771 -p 50723:50723 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolution-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myawesometmlsolution-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=45281  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=51771  \-\-env SOLUTIONVIPERVIZPORT=50723 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=36011 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=40795 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolution-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=50723
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=45281
...
It can be accessed by entering: http://localhost:51771
...
.. important::
   http://localhost:50723/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:50723/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:50723/<html file>
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=45281, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39261, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45961, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39331, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40203, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=32955, HPDEHOST=127.0.1.1, HPDEPORT=46337, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33689

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1378-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-6658-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
