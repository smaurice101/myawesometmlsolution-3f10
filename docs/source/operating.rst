...
Generated On: 2025-02-21 18:51:43 UTC
...
.. code-block::
   ...
   docker run -d -p 40707:40707 -p 43859:43859 -p 45253:45253 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=40707 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          -v /your_localmachine/foldername:/rawdata:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=43859 \
          --env SOLUTIONVIPERVIZPORT=45253 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=40707, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45353, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36687, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33939, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=39909, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43875, HPDEHOST=127.0.1.1, HPDEPORT=39725, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33553

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9776-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-1742-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
