...
Generated On: 2024-10-18 13:43:49 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46469  \-\-env VIPERVIZPORT=56031  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:56031/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:56031/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 33585:33585 -p 43649:43649 -p 46257:46257 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolution-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myawesometmlsolution-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=33585  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=43649  \-\-env SOLUTIONVIPERVIZPORT=46257 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=46469 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=56031 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolution-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=46257
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=33585
...
It can be accessed by entering: http://localhost:43649
...
.. important::
   http://localhost:46257/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:46257/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:46257/<html file>
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=33585, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35509, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41595, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46157, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46181, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40499, HPDEHOST=127.0.1.1, HPDEPORT=34221, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33451

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4493-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-1092-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
