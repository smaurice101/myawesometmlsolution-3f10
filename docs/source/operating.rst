...
Generated On: 2024-12-21 03:07:42 UTC
...
.. code-block::
   ...
   docker run -d -p 57917:57917 -p 51869:51869 -p 60193:60193 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=57917 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=51869 \
          --env SOLUTIONVIPERVIZPORT=60193 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=57917, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44087, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43019, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34113, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46511, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40173, HPDEHOST=127.0.1.1, HPDEPORT=40689, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41681

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5481-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-8293-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
