...
Generated On: 2024-09-19 00:15:46 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42015  \-\-env VIPERVIZPORT=38255  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:38255/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:38255/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 43855:43855 -p 51005:51005 -p 55767:55767 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolution-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myawesometmlsolution-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=43855  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=51005  \-\-env SOLUTIONVIPERVIZPORT=55767 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=42015 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=38255 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolution-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=55767
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=43855
...
It can be accessed by entering: http://localhost:51005
...
.. important::
   http://localhost:55767/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=500&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:55767/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:55767/<html file>
...
.. important::
   https://github.com/smaurice101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=43855, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43729, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38279, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43199, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=44239, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43125, HPDEHOST=127.0.1.1, HPDEPORT=40881, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43009

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8557-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-5527-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
