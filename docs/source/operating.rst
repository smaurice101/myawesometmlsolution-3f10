...
.. code-block::
   ...
   docker run -d -p 40259:40259 -p 59573:59573 -p 37173:37173 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=40259 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=59573 \
          --env SOLUTIONVIPERVIZPORT=37173 \
...
It can be accessed by entering: http://localhost:59573
...
.. important::
   http://localhost:37173/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:37173/<html file>
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=40259, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42805, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41591, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39023, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40909, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36687, HPDEHOST=127.0.1.1, HPDEPORT=36949, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40255
