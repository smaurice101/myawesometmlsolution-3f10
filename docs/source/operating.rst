...
Generated On: 2024-12-31 18:58:04 UTC
...
.. code-block::
   ...
   docker run -d -p 42337:42337 -p 45301:45301 -p 59667:59667 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=42337 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=45301 \
          --env SOLUTIONVIPERVIZPORT=59667 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=42337, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35579, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33031, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42505, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46487, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40583, HPDEHOST=127.0.1.1, HPDEPORT=41593, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42069

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5873-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-5216-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
