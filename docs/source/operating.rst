...
Generated On: 2024-12-24 23:47:35 UTC
...
.. code-block::
   ...
   docker run -d -p 57599:57599 -p 34965:34965 -p 58729:58729 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=57599 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=34965 \
          --env SOLUTIONVIPERVIZPORT=58729 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=57599, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38127, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45893, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42221, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33513, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40357, HPDEHOST=127.0.1.1, HPDEPORT=35931, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38117

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-700-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-8599-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
