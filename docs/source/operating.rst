[myawesometmlsolution-3f10] Operating Details
====================================

Generated On: 2024-10-17 16:28:59 UTC
...
.. important::
   ...
   **not be valid if your [myawesometmlsolution-3f10] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolution-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38095  \-\-env VIPERVIZPORT=49329  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:49329/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:49329/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 59247:59247 -p 47419:47419 -p 59127:59127 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolution-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myawesometmlsolution-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=59247  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=47419  \-\-env SOLUTIONVIPERVIZPORT=59127 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=38095 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=49329 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/myawesometmlsolution-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=59127
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=59247
...
It can be accessed by entering: http://localhost:47419
...
.. important::
   http://localhost:59127/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:59127/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:59127/<html file>
...
[myawesometmlsolution-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-3f10
...
.. important::
   solution_preprocessing_dag-myawesometmlsolution-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=59247, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46841, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=34641, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46491, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34587, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=34609, HPDEHOST=127.0.1.1, HPDEPORT=38051, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=36173

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9884-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-1920-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
