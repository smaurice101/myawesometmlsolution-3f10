...
Generated On: 2024-12-08 20:01:42 UTC
...
.. important::
   http://localhost:49689/dashboard.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. code-block::
   ...
   docker run -d -p 47329:47329 -p 37695:37695 -p 57051:57051 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=47329 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=37695 \
          --env SOLUTIONVIPERVIZPORT=57051 \
...
It can be accessed by entering: http://localhost:37695
...
.. important::
   http://localhost:57051/dashboard.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:57051/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:57051/<html file>
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=47329, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=34477, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39207, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45973, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34329, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41007, HPDEHOST=127.0.1.1, HPDEPORT=44247, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40439
