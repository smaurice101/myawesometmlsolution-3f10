...
Generated On: 2024-12-19 23:21:23 UTC
...
.. code-block::
   ...
   docker run -d -p 53021:53021 -p 43959:43959 -p 38897:38897 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=53021 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=43959 \
          --env SOLUTIONVIPERVIZPORT=38897 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=53021, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35051, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36775, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40817, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43263, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44737, HPDEHOST=127.0.1.1, HPDEPORT=37679, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34321

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3255-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, python-preprocess-152-myawesometmlsolution-3f10,solution_preprocessing_dag-myawesometmlsolution-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
